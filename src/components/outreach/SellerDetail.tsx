      ...
      <div className="mirakl-card-elevated mb-4 animate-fade-in p-4 lg:mb-6 lg:p-6">
        <div className="flex flex-col gap-3 sm:flex-row sm:items-start sm:justify-between">
          <div>
            ...
            <div className="mt-3 flex flex-wrap gap-4">
              <InfoChip label="Categorie" value={seller.category?.label || "—"} />
        ...
        <div className="mt-4 flex flex-wrap gap-3">
          <span className="rounded-lg px-3 py-1.5 text-[12px] font-bold" style={{ background: "#2764FF", color: "#FFFFFF" }}>
            Best match : {record.topRecommendation?.marketplaceName || seller.marketplace?.["marketplace name"] || "—"}
          </span>
          ...
          >
            {enrichStatus === "loading" ? "Recherche contacts..." : enrichStatus === "done" ? "✓ Contacts trouvés" : enrichStatus === "error" ? "Erreur" : "Enrichir les contacts"}
          </button>
          <button
            onClick={() => {
        ...
        <div className="mt-5 grid gap-6 lg:grid-cols-[1.2fr_0.8fr]">
          <div className="rounded-2xl border p-4" style={{ borderColor: "#E2E8F0" }}>
            <p className="mb-3 text-[12px] font-bold" style={{ color: "#03182F" }}>Score breakdown</p>
          ...
          <div className="space-y-4">
            <div className="rounded-2xl border p-4" style={{ borderColor: "#E2E8F0" }}>
              <p className="mb-3 text-[12px] font-bold" style={{ color: "#03182F" }}>Signaux</p>
            ...
            <div className="rounded-2xl border p-4" style={{ borderColor: "#E2E8F0" }}>
              <p className="mb-3 text-[12px] font-bold" style={{ color: "#03182F" }}>Top operators</p>
